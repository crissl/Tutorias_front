...
export class RegistroComponent implements OnInit {
  ...
  enviarEmail() {
    ...
    this.envios = {
      asunto: "Registro de Asisitencia ",
      mensaje: "<b>Se ha registrado  exitosamente  la asistencia <b> <br> "
     + "que  los estudiantes:" + this.estudiante + " "+this.data.asistencia.confirmacion+ "asisisterion, el dia "+ Date.now + ". Gracias por su atención.",
      sistema: "TUTORIAS",
      email: this.correo
