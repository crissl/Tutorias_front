...
export class PlanificacionReforzamientoComponent implements OnInit {
  ...
  listarHorarioSelecto() {
    ...
    this.restService.findDataByHorarioReforzamiento("horarioPlanificacion/", this.campus1,"/", this.dia1,"/",this.horhoraInicioEscogidoa_INICIO,"/",this.hora_FIN).subscribe(
      data => {
        if (data) {
          console.log('datos2', data)
          this.aulas2 = data;
