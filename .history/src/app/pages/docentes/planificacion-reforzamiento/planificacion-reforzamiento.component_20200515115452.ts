...
export class PlanificacionReforzamientoComponent implements OnInit {
  ...
  horarioI: HoraI[] = [
    {value: 'horarioI-0', viewValue: 'Steak'},
    {value: 'horarioI-1', viewValue: 'Pizza'},
    {value: 'horarioI-2', viewValue: 'Tacos'},
    {value: 'horarioI-3', viewValue: 'Pizza'},
    {value: 'horarioI-4', viewValue: 'Pizza'},
    {value: 'horarioI-5', viewValue: 'Pizza'},
