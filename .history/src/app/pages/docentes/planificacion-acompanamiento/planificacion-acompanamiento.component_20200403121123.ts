...
export class PlanificacionAcompanamientoComponent implements OnInit {
  ...
  aula: boolean = true
  constructor(private service: PersonalDataService, private restService: RestService, private restService: RestService, public toast: ToastrService ) { }
  datosGuardar : any;
  ncr:any;
...
campus: any;
   ...
   listarCamp(){
     this.restService.findDataById("campus", this.codigo ).subscribe(
       data => {
