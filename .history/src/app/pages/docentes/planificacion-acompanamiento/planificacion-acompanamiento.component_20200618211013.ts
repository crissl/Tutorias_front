...
export class PlanificacionAcompanamientoComponent implements OnInit {
  ...
  enviarEmail2() {
    ...
    this.envios = {
      ...
      mensaje: "<b> la planificacíon de la asignatura <b> <br>  "
       + + " Fue enviada a los estudiantes" +  " y establecida para la fecha" + this.datosGuardar.fechaTutoria + " en el horario" + this.horaInicio+ this.horaInicio" ha dictarse en " + this.datosGuardar.aula + " con el tema " + this.datosGuardar.tema + " y la observación " + this.datosGuardar.observacion + ". Gracias por su atención.",
      sistema: "TUTORIAS",
      email: this.correo
