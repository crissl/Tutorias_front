...
export class PlanificacionAcompanamientoComponent implements OnInit {
  ...
  enviarEmail() {
    ...
    this.envios = {
      ...
      mensaje: "<b> usted ha sido notificado <b> <br>  "
        + " Para asistir a una tutoria de : " + this.datosGuardar.tipoTutoria + " , fue establecida para la fecha" + Date.now + " ha dictarse en " + this.datosGuardar.aula + " con el tema " + this.datosGuardar.tema + " y la observación " + this.datosGuardar.observacion + ". Gracias por su atención.",
      sistema: "TUTORIAS",
      email: this.correo
  ...
  enviarEmail2() {
    ...
    this.envios = {
      ...
      mensaje: "<b> la planificacíon de la tutoria  <b> <br>  "
       + + " Fue enviada exitosamente a los estudiantes" +  " y establecida para la fecha" + this.datosGuardar.fechaTutoria + " en el horario" + this.horaInicio+ this.horaFin +" ha dictarse en " + this.datosGuardar.aula + " con el tema " + this.datosGuardar.tema + " y la observación " + this.datosGuardar.observacion + ". Gracias por su atención.",
      sistema: "TUTORIAS",
      email: this.correo
