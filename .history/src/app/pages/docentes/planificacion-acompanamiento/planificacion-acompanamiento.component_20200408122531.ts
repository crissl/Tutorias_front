...
export class PlanificacionAcompanamientoComponent implements OnInit {
  ...
  foods: Dias[] = [
    ...
    {value: 'lunes-1', viewValue: 'SZARPGN_CAMPVAR9'},
    {value: 'martes-1', viewValue: 'SZARPGN_CAMPVA10'},
    {value: 'miercoles-1', viewValue: 'SZARPGN_CAMPVA11'},
    {value: 'jueves-1', viewValue: 'SZARPGN_CAMPVA12'},
    {value: 'viernes-1', viewValue: 'SZARPGN_CAMPVA13'},
    {value: 'domingo-2', viewValue: 'SZARPGN_CAMPVA14'}
  ];
