...
export class PlanificacionAcompanamientoComponent implements OnInit {
  ...
  myDate: Dia[] = [
    { dia: 'domingo-1', viewValue: 'SZARPGN_CAMPVA15' },
    { dia: 'lunes-2', viewValue: 'SZARPGN_CAMPVAR9' },
    { dia: 'martes-3', viewValue: 'SZARPGN_CAMPVA10' },
    { dia: 'miercoles-4', viewValue: 'SZARPGN_CAMPVA11' },
    { dia: 'jueves-5', viewValue: 'SZARPGN_CAMPVA12' },
    { dia: 'viernes-6', viewValue: 'SZARPGN_CAMPVA13' },
    { dia: 'domingo-7', viewValue: 'SZARPGN_CAMPVA14' }
  ];
  ...
  listarHorario() {
    ...
    this.restService.findDataByCampus("horario/", this.campus,"/", this.dia).subscribe(
      data => {
        if (data) {
