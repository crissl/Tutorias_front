  ...
  enviarEmail2() {
    ...
    this.envios = {
      ...
      mensaje: "<b> la planificacíon de la tutoria de <b> <br>  "
       + this.datosGuardar.tipoTutoria + " Fue llenadaenviada a los estudiantes" +  " y establecida para la fecha" + this.datosGuardar.fechaTutoria + " en el horario" + this.horaInicio+ this.horaFin +" ha dictarse en " + this.datosGuardar.aula + " con el tema " + this.datosGuardar.tema + " y la observación " + this.datosGuardar.observacion + ". Gracias por su atención.",
      sistema: "TUTORIAS",
      email: this.correo
