...
export class SolicitudAcompanamientosComponent implements OnInit {
 ...
 titleEstudiante = TutoriaConstants.DATOSESTUDIANTE;
  ...
  constructor(private outer: Router, private fb: FormBuilder, private service: PersonalDataService, private restService: RestService, public toast: ToastrService) { }
    ...
    this.restService.addData(this.datosGuardar, "crearPlanificacion").subscribe(
      data => {
        ...
        if(data){
          ...
          this.router.navigate(['/listaTutoriasSolicitadas']);
