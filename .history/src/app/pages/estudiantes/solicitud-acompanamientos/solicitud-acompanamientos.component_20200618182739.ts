...
export class SolicitudAcompanamientosComponent implements OnInit {
  ...
  enviarEmail() {
    ...
    this.envios = {
      ...
      mensaje: "<b> La solicitud fue procesada y llenada es el <b> <br>  "
        + Date.now + "por  el estudiante: " + this.estudiante + "con el tema " + this.datosGuardar.tema + " y la observación" + this.datosGuardar.observaciones.observacion ,
      sistema: "TUTORIAS",
      email: this.correo
