...
export class SolicitudAcompanamientosComponent implements OnInit {
 ...
 titleEstudiante = TutoriaConstants.DATOSESTUDIANTE;
  ...
  constructor(private fb: FormBuilder, private service: PersonalDataService, private restService: RestService, public toast: ToastrService, private formBuilder: FormBuilder) { }
...
initFor() this.form =  this.fb.group({
