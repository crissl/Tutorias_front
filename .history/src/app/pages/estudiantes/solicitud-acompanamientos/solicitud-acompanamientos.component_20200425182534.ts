...
export class SolicitudAcompanamientosComponent implements OnInit {
 ...
 titleEstudiante = TutoriaConstants.DATOSESTUDIANTE;
  ...
  constructor(private fb: FormBuilderprivate service: PersonalDataService, private restService: RestService, public toast: ToastrService, private formBuilder: FormBuilder) { }
