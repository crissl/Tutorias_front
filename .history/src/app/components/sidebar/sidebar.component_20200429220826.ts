...
export const ROUTES: RouteInfoS[] = [
  ...
  // { path: '/matriculaPac', title: 'Matrícula PAC', icon: 'person', class: '' },
  // { path: '/matriculaUte', title: 'Matrícula Titulación', icon: 'content_paste', class: '' },
  { pathSolicitud: '/solicitudAcompanamiento', titleSolicitud: 'Solicitud Acompañamiento', iconSolicitud: 'supervised_user_circle', class: '' },
  { pathSolicitud: '/solicitudReforzamiento', titleSolicitud: ' Solicitud Reforzamiento', iconSolicitud: 'announcement', class: '' },
  { pathSolicitud: '/confirmacionAsistencia', titleSolicitud: ' Confirmación Asistencia', iconSolicitud: 'how_to_reg', class: '' },
  { pathSolicitud: '/planificacionAcompanamiento', titleSolicitud: 'Planifición Acompañamiento', iconSolicitud: 'assignment_ind', class: '' },
  { pathSolicitud: '/planificacionReforzamieto', titleSolicitud: ' Planificación Reforzamiento', iconSolicitud: 'assignment', class: '' },
  { pathSolicitud: '/registroAsistencia', titleSolicitud: 'Registro Asistencias', iconSolicitud: 'chrome_reader_mode', class: '' },
  { pathSolicitud: '/listaAlumnosAcompanamiento', titleSolicitud: 'Alumnos Acompañamiento',   { pathSolicitud: '/listaAlumnosAcompanamiento', titleSolicitud: 'Alumnos Acompañamiento', iciconSolicitudon: 'chrome_reader_mode', class: '' },
  : 'chrome_reader_mode', class: '' },
  { pathSolicitud: '/listaTutoriasPlanificadas', titleSolicitud: 'Tutorias Planifiacadas', icon: 'chrome_reader_mode', class: '' },
  { pathSolicitud: '/listaTutoriasSolicitadas', titleSolicitud: 'Tutorias Solicitadas', icon: 'chrome_reader_mode', class: '' }
