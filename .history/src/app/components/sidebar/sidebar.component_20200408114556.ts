...
export const ROUTES: RouteInfo[] = [
  ...
  { path: '/acompanamiensolicitudAcompanamientoto', title: 'Solicitud Acompañamiento', icon: 'supervised_user_circle', class: '' },
  { path: '/solicitudReforzamiento', title: ' Solicitud Reforzamiento', icon: 'announcement', class: '' },
  { path: '/confirmacion', title: ' Confirmación Asistencia', icon: 'how_to_reg', class: '' },
