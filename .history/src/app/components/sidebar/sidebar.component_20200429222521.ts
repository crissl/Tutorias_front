...
declare interface RouteInfoS {
  pathSolicitud: string;
  titleSolicitud: string;
  iconSolicitud: string;
  classSolicitud: string;
}
export const ROUTESS: RouteInfoS[] = [

  { pathSolicitud: '/solicitudAcompanamiento', titleSolicitud: 'Solicitud Acompañamiento', iconSolicitud: 'supervised_user_circle', classSolicitud: '' },
  { pathSolicitud: '/solicitudReforzamiento', titleSolicitud: ' Solicitud Reforzamiento', iconSolicitud: 'announcement', classSolicitud: '' }
  
];
declare interface RouteInfoP{
  pathPlanificacion: string;
  titlePlanificacion: string;
  iconPlanificacion: string;
  classPlanificacion: string;
}
export const ROUTESP: RouteInfoP[] = [

  { pathPlanificacion: '/planificacionAcompanamiento', titlePlanificacion: 'Planifición Acompañamiento', iconPlanificacion: 'assignment_ind', classPlanificacion: '' },
  { pathPlanificacion: '/planificacionReforzamieto', titlePlanificacion: ' Planificación Reforzamiento', iconPlanificacion: 'assignment', classPlanificacion: '' }
];

declare interface RouteInfoC{
  pathAsistencia: string;
  titleAsistencia: string;
  iconAsistencia: string;
  classAsistencia: string;
}
export const ROUTESC: RouteInfoC[] = [

  { pathAsistencia: '/confirmacionAsistencia', titleAsistencia: ' Confirmación Asistencia', iconAsistencia: 'how_to_reg', classAsistencia: '' },
  { pathAsistencia: '/registroAsistencia', titleAsistencia: 'Registro Asistencias', iconAsistencia: 'chrome_reader_mode', classAsistencia: '' },
];

declare interface RouteInfoL{
  pathAsistencia: string;
  titleAsistencia: string;
  iconAsistencia: string;
  classAsistencia: string;
}
export const ROUTESL: RouteInfoL[] = [

  { pathAsistencia: '/listaAlumnosAcompanamiento', titleAsistencia: 'Alumnos Acompañamiento', iconAsistencia: 'chrome_reader_mode', classAsistencia: '' },
  { pathAsistencia: '/listaTutoriasPlanificadas', titleAsistencia: 'Tutorias Planifiacadas', iciconAsistenciaon: 'chrome_reader_mode', classAsistencia: '' },
  { pathAsistencia: '/listaTutoriasSolicitadas', titleAsistencia: 'Tutorias Solicitadas', iconAsistencia: 'chrome_reader_mode', classAsistencia: '' }
];
