...
export const ROUTES: RouteInfo[] = [
  ...
  { path: '/listaAlumnosAcompanamiento', title: 'Registro Asistencias', icon: 'chrome_reader_mode', class: '' },
  { path: '/listaTutoriasPlanifiacadas', title: 'Tutorias Planifiacadas', icon: 'chrome_reader_mode', class: '' },
  { path: '/listaTutoriasSolicitadas', title: 'Registro Asistencias', icon: 'chrome_reader_mode', class: '' }
