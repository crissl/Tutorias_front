...
export const ROUTES: RouteInfo[] = [
  ...
  { path: '/planificacionReforzamieto', title: 'Planifición Acompañamiento', icon: 'assignment_ind', class: '' },
  { path: '/planificacionAcompanamiento', title: ' Planificación Reforzamiento', icon: 'assignment', class: '' },
