...
export const ROUTESS: RouteInfoS[] = [
  ...
  { pathSolicitud: '/confirmacionAsistencia', titleSolicitud: ' Confirmación Asistencia', iconSolicitud: 'how_to_reg', classSolicitud: '' },
  { pathSolicitud: '/planificacionAcompanamiento', titleSolicitud: 'Planifición Acompañamiento', iconSolicitud: 'assignment_ind', classSolicitud: '' },
  { pathSolicitud: '/planificacionReforzamieto', titleSolicitud: ' Planificación Reforzamiento', iconSolicitud: 'assignment', classSolicitud: '' },
  { pathSolicitud: '/registroAsistencia', titleSolicitud: 'Registro Asistencias', iconSolicitud: 'chrome_reader_mode', classSolicitud: '' },
  { pathSolicitud: '/listaAlumnosAcompanamiento', titleSolicitud: 'Alumnos Acompañamiento', iconSolicitud: 'chrome_reader_mode', classSolicitud: '' },
  { pathSolicitud: '/listaTutoriasPlanificadas', titleSolicitud: 'Tutorias Planifiacadas', iconSolicitud: 'chrome_reader_mode', classSolicitud: '' },
  { pathSolicitud: '/listaTutoriasSolicitadas', titleSolicitud: 'Tutorias Solicitadas', iconSolicitud: 'chrome_reader_mode', classSolicitud: '' }
