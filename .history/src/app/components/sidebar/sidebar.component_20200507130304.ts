  ...
  ngOnInit() {
    ...
    if (this.isLoggedIn) {
       ...
       console.log(this.userName);
        this.personaldataService.findDataUser(environment.,this.userName).subscribe((data: {}) => {
          this.persona = data[0];
          this.personaldataService.findDataUser('https://miespemovil.espe.edu.ec/recovery/restWs/userldap/',this.userName).subscribe(
            data =>{
