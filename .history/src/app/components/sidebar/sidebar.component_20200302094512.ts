...
export const ROUTES: RouteInfo[] = [
  ...
  { path: '/acompanamiento', title: 'Solicitud Acompañamiento', icon: 'perm_contact_calendarannouncement', class: '' },
  { path: '/reforzamiento', title: ' Solicitud Reforzamiento', icon: '', class: '' },
