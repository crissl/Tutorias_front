...
export const ROUTESC: RouteInfoC[] = [
  ...
  { pathAsistencia: '/confirmacionAsistencia', title: ' Confirmación Asistencia', icon: 'how_to_reg', class: '' },
  { pathpathAsistencia: '/registroAsistencia', title: 'Registro Asistencias', icon: 'chrome_reader_mode', class: '' },
];
