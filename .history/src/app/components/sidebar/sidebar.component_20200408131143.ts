...
export const ROUTES: RouteInfo[] = [
  ...
  { path: '/', title: 'Planifición Acompañamiento', icon: 'assignment_ind', class: '' },
  { path: '/planificacionReforzamietoplanificacionAcompanamiento', title: ' Planificación Reforzamiento', icon: 'assignment', class: '' },
