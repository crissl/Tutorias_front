...
export const ROUTES: RouteInfo[] = [
  ...
  { path: '/solicitudAcompanamiento', title: 'Solicitud de Acompañamiento', icon: 'supervised_user_circle', class: '' },
  { path: '/solicitudReforzamiento', title: ' Solicitud de Reforzamiento', icon: 'announcement', class: '' },
  ...
  { path: '/listaTutoriasPlanificadas', title: 'Tutorias Planificadas', icon: 'chrome_reader_mode', class: '' },
