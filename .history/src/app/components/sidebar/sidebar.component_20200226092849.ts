...
export const ROUTES: RouteInfo[] = [
  ...
  { path: '/reforzamiento', title: 'Matrícula Solicitud Acompañamiento', icon: 'content_paste', class: '' },
  { path: '/acompanamiento', title: 'Solicitud Acompañamiento', icon: 'content_paste', class: '' }
