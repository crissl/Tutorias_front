...
export const ROUTES: RouteInfo[] = [
  ...
  { path: '/acompanamiento', title: 'Solicitud Acompañamiento', icon: 'acalendar_today', class: '' },
  { path: '/reforzamiento', title: ' Solicitud Reforzamiento', icon: 'perm_contact_calendar', class: '' },
  { path: '/confirmacion', title: ' Confrimación Asistencia', icon: 'done_all', class: '' },
