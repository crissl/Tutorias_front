...
export const ROUTES: RouteInfo[] = [
  ...
  { path: '/acompanamientoPla', title: 'Planificacion Acompañamiento', icon: 'assignment_ind', class: '' },
  { path: '/reforzamientoPla', title: ' Planificacion Reforzamiento', icon: 'assignment', class: '' },
  { path: '/registro', title: ' Confrimacion Asistencia', icon: 'assignment', class: '' }
