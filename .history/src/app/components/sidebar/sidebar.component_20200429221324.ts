...
export const ROUTESP: RouteInfoS[] = [
  ...
  { pathPlanificacion: '/planificacionAcompanamiento', titlePlanificacion: 'Planifición Acompañamiento', iconPlanificacion: 'assignment_ind', class: '' },
  { pathPlanificacion: '/planificacionReforzamieto', titlePlanificacion: ' Planificación Reforzamiento', icoiconPlanificacionn: 'assignment', class: '' },
];
