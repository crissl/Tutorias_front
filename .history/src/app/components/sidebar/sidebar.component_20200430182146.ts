...
export const ROUTESA: RouteInfo[] = [
  ...
  { path: '/solicitudAcompanamiento', title: 'Solicitud Acompañamiento', icon: 'supervised_user_circle', class: '' },
  { path: '/planificacionAcompanamiento', title: 'PlanifiAcompañamiento', icon: 'assignment_ind', class: '' },
  { path: '/confirmacionAsistencia', title: 'Asistencia', icon: 'how_to_reg', class: '' },
...
export const ROUTESR: RouteInfo[] = [
  ...
  { path: '/registroAsistencia', title: 'Asistencias', icon: 'chrome_reader_mode', class: '' }
