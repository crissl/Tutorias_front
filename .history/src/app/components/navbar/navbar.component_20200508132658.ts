...
export class NavbarComponent implements OnInit {
    ...
    public cedula : String = localStorage.getItem('nombreCompleto');
    ...
    // getUserbyid() {
    //     this.personaldataService.getPidmByUsuario(environment.servicioUserldap + this.userName).subscribe(
    //         data => {
    //             if (data) {
    //                 this.nombres = data;
    //                 console.log('nombre',this.nombres)

    //                 this.id = data.nombreCompleto
