...
export class NavbarComponent implements OnInit {
   ...
   nombres : any;
    ...
    constructor( private usuarioService:UsuarioService, private personaldataService: PersonalDataService, private authService: AuthService, location: Location,  private element: ElementRef, private router: Router) {
