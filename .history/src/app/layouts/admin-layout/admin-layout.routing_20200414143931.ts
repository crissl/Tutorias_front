...
import { ListaAlumnosAcompanamientoComponent } from 'app/pages/estudiantes/lista-alumnos-acompanamiento/lista-alumnos-acompanamiento.component';
export const AdminLayoutRoutes: Routes = [
    ...
    { path: 'listaTutoriasPlanificadas',   component: ListaTutoriasSolicitadasComponent},
    { path: 'listaTutoriasSolicitadas',   component: UserProfileComponent},
