...
export const AdminLayoutRoutes: Routes = [
    ...
    { path: 'reforzamientoPla',   component: ConfirmacionAsistenciaComponent},
    { path: 'acompanamientoPla',   component: ConfirmacionAsistenciaComponent},
    { path: 'registro',   component: ConfirmacionAsistenciaComponent},
