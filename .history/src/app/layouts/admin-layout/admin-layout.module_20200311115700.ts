...
import { ConfirmarComponent, NgbdAlertCustom } from '../../pages/estudiantes/confirmacion-asistencia/confirmar/confirmar.component';
import { BrowserModule,NgbModule } from '@angular/platform-browser';
