...
export class PersonalDataService {
  ...
  //   );
  // }
  findDataUser(url:stringuser: String) {
    return this.http2.get('https://servicios.espe.edu.ec:8443/UPBannerWS-0.0.1-SNAPSHOT/UPBannerWS/user/'+ user , httpOptions).pipe(
      map(
        (res: any) => {
          return res;
        },
